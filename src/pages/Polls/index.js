...
import PollPublish from '../PollPublish'
    ...
    return (
      <div className="Polls">
        <div className="action-buttons">
          <Button className="pt-button" onClick={this.onNewPollClick} text="New poll" intent={Intent.PRIMARY}/>
        </div>
        {$table}
        <Dialog
          ...
          isOpen={this.state.createPoll.isOpen}
          title="Create Poll">
          <div className="pt-dialog-body">
            <PollPublish onSubmit={this.onNewPollSubmit} onCancel={this.onNewPollCancel} action={'create'}/>
          </div>
        </Dialog>
        <Dialog
          canEscapeKeyClose={false}
          canOutsideClickClose={false}
          isCloseButtonShown={false}
          isOpen={this.state.updatePoll.isOpen}
          title="Update Poll">
          <div className="pt-dialog-body">
            <PollPublish onSubmit={this.onUpdatePollSubmit} onCancel={this.onUpdatePollCancel} onDelete={this.onPollDelete} action={'update'} id={this.state.updatePoll.id}/>
          </div>
        </Dialog>
      </div>
    )
